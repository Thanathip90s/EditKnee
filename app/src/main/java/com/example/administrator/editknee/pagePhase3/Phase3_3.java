...
public class Phase3_3 extends UsageBaseActivity3 {
    ...
    private EditText note3_3Input, editNum;
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn_nextPhase3:
                ...
                if (counter >= 0 && counter <= intEdt - 1 && note3_3Input.getText().toString().equals("")) {
                    Toast.makeText(this, "กรุณากรอกสาเหตุคะ", Toast.LENGTH_SHORT).show();
                } else if (counter >= 0 && counter <= intEdt - 1 && note3_3Input != null) {
                    saveDbPhase3();
                } else {
                    saveDbPhase3();
                }
