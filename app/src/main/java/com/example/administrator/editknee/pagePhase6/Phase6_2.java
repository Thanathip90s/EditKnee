...
public class Phase6_2 extends UsageBaseActivity6 {
    ...
    private EditText note6_2Input, editNum;
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn_nextPhase6:
                ...
                if (counter >= 0 && counter <= intEdt - 1 && note6_2Input.getText().toString().equals("")) {
                    Toast.makeText(this, "กรุณากรอกสาเหตุคะ", Toast.LENGTH_SHORT).show();
                } else if (counter >= 0 && counter <= intEdt - 1 && note6_2Input != null) {
                    saveDbPhase6();
                } else {
                    saveDbPhase6();
                }
