...
public class HistoryFirstPhase4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("กราฟระยะที่ 4");

        DatabaseManager databaseManager = DatabaseManager.getInstance(this);
        List<DBPhase4> dbPhase4s = databaseManager.getPhase4();
        ...
        int length = dbPhase4s.size();
        for (int i = 0; i < length; i++) {
            series.add(i + 1, dbPhase4s.get(i).getNumber4_1());
            series2.add(i + 1,dbPhase4s.get(i).getNumber4_2());
            series3.add(i + 1, dbPhase4s.get(i).getNumber4_3());
            series4.add(i + 1, dbPhase4s.get(i).getNumber4_4());
            series5.add(i + 1, dbPhase4s.get(i).getNumber4_5());
            series6.add(i + 1, dbPhase4s.get(i).getNumber4_6());
        }
        ...
        LinearLayout chartLayout2 = (LinearLayout) findViewById(R.id.ViewGraph4);
