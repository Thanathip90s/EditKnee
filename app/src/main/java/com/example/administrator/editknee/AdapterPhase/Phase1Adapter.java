...
//                startEditForm(dbphase1.getNumber1_1());
//            }
//        });
//    }
//
...
//        intent.putExtra(Phase1_1.EXTRA_PERSON_ID, phase1Id);
//        ((Activity) mContext).startActivityForResult(intent, FirstPhase1.REQUEST_UPDATE);
//    }
