...
public class Phase3_1 extends UsageBaseActivity3 {
    ...
    private EditText note3_1Input, editNum;
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn_nextPhase3:
                ...
                if (counter >= 0 && counter <= intEdt - 1 && note3_1Input.getText().toString().equals("")) {
                    Toast.makeText(this, "กรุณากรอกสาเหตุคะ", Toast.LENGTH_SHORT).show();
                } else if (counter >= 0 && counter <= intEdt - 1 && note3_1Input != null) {
                    saveDbPhase3();
                } else {
                    saveDbPhase3();
                }
