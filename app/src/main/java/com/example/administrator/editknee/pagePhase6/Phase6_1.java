...
public class Phase6_1 extends UsageBaseActivity6 {
    ...
    private EditText note6_1Input, editNum;
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn_nextPhase6:
                ...
                if (counter >= 0 && counter <= intEdt - 1 && note6_1Input.getText().toString().equals("")) {
                    Toast.makeText(this, "กรุณากรอกสาเหตุคะ", Toast.LENGTH_SHORT).show();
                } else if (counter >= 0 && counter <= intEdt - 1 && note6_1Input != null) {
                    saveDbPhase6();
                } else {
                    saveDbPhase6();
                }
