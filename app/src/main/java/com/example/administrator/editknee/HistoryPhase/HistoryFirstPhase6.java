...
public class HistoryFirstPhase6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("กราฟระยะที่ 6");
        DatabaseManager databaseManager = DatabaseManager.getInstance(this);
        List<DBPhase6> dbPhase6s = databaseManager.getPhase6();
        ...
        int length = dbPhase6s.size();
        for (int i = 0; i < length; i++) {
            series.add(i + 1, dbPhase6s.get(i).getNumber6_1());
            series2.add(i + 1,dbPhase6s.get(i).getNumber6_2());
            series3.add(i + 1, dbPhase6s.get(i).getNumber6_3());
            series4.add(i + 1, dbPhase6s.get(i).getNumber6_4());
            series5.add(i + 1, dbPhase6s.get(i).getNumber6_5());
            series6.add(i + 1, dbPhase6s.get(i).getNumber6_6());
        }
        ...
        LinearLayout chartLayout2 = (LinearLayout) findViewById(R.id.ViewGraph6);
