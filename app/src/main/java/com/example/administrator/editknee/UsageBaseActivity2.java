...
public abstract class UsageBaseActivity2 extends Activity implements View.OnClickListener {
    ...
    protected void injectCommonViews() {
        nextBtn = (Button) findViewById(R.id.btn_nextPhase2);
        nextBtn.setOnClickListener(this);


        stateprogressbar = (StateProgressBar) findViewById(R.id.usage_stateprogressbar2);
