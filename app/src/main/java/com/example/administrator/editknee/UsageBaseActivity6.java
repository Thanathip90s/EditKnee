...
public abstract class UsageBaseActivity6 extends Activity implements View.OnClickListener {
    ...
    protected void injectCommonViews() {
        nextBtn = (Button) findViewById(R.id.btn_nextPhase6);
        nextBtn.setOnClickListener(this);


        stateprogressbar = (StateProgressBar) findViewById(R.id.usage_stateprogressbar6);
