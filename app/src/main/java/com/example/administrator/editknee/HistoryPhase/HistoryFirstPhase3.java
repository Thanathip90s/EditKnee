...
public class HistoryFirstPhase3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("กราฟระยะที่ 3");

        DatabaseManager databaseManager = DatabaseManager.getInstance(this);
        List<DBPhase3> dbPhase3s = databaseManager.getPhase3();
        ...
        XYSeries series5 = new XYSeries("เดิน-สาม-ขา");

        int length = dbPhase3s.size();
        for (int i = 0; i < length; i++) {
            series.add(i + 1, dbPhase3s.get(i).getNumber3_1());
            series2.add(i + 1,dbPhase3s.get(i).getNumber3_2());
            series3.add(i + 1, dbPhase3s.get(i).getNumber3_3());
            series4.add(i + 1, dbPhase3s.get(i).getNumber3_4());
            series5.add(i + 1, dbPhase3s.get(i).getNumber3_5());
        }
        ...
        LinearLayout chartLayout2 = (LinearLayout) findViewById(R.id.ViewGraph3);
