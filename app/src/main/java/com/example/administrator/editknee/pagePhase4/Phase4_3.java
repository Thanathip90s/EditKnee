...
public class Phase4_3 extends UsageBaseActivity4 {
    public static int REQUEST_UPDATE = 99;
    public static String EXTRA_PHASE4_ID = "phase4Id";
    private TextView number4_3Input, showValue;
    private EditText note4_3Input, editNum;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        number4_3Input = (TextView) findViewById(R.id.number4_3);
        note4_3Input = (EditText) findViewById(R.id.editText_note4_3);
    ...
    private void updateFormView() {
        ...
        if (dbPhase4 != null) {
            number4_3Input.setText(String.valueOf(dbPhase4.getNumber4_3()));
            note4_3Input.setText(dbPhase4.getNote3());
        }
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn_nextPhase4:
                ...
                if (counter >= 0 && counter <= intEdt - 1 && note4_3Input.getText().toString().equals("")) {
                    Toast.makeText(this, "กรุณากรอกสาเหตุคะ", Toast.LENGTH_SHORT).show();
                } else if (counter >= 0 && counter <= intEdt - 1 && note4_3Input != null) {
                    saveDbPhase4();
                } else {
                    saveDbPhase4();
                }
    ...
    private void saveDbPhase4() {
        ...
        DBPhase4 dbPhase4 = DatabaseManager.getInstance(this)
                .getDBPhase4(mPhase4Id);
        dbPhase4.setNumber4_3(Integer.parseInt(number4_3Input.getText().toString()));
        dbPhase4.setNote3(note4_3Input.getText().toString());

        // Store DBPhase4
        Intent intent = new Intent(Phase4_3.this, Phase4_4.class);
