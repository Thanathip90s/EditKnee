...
public class Phase4_2 extends UsageBaseActivity4 {
    public static int REQUEST_UPDATE = 99;
    public static String EXTRA_PHASE4_ID = "phase4Id";
    private TextView number4_2Input, showValue;
    private EditText note4_2Input, editNum;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        number4_2Input = (TextView) findViewById(R.id.number4_2);
        note4_2Input = (EditText) findViewById(R.id.editText_note4_2);
    ...
    private void updateFormView() {
        ...
        if (dbPhase4 != null) {
            number4_2Input.setText(String.valueOf(dbPhase4.getNumber4_2()));
            note4_2Input.setText(dbPhase4.getNote2());
        }
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn_nextPhase4:
                ...
                if (counter >= 0 && counter <= intEdt - 1 && note4_2Input.getText().toString().equals("")) {
                    Toast.makeText(this, "กรุณากรอกสาเหตุคะ", Toast.LENGTH_SHORT).show();
                } else if (counter >= 0 && counter <= intEdt - 1 && note4_2Input != null) {
                    saveDbPhase4();
                } else {
                    saveDbPhase4();
                }
    ...
    private void saveDbPhase4() {
        ...
        DBPhase4 dbPhase4 = DatabaseManager.getInstance(this)
                .getDBPhase4(mPhase4Id);
        dbPhase4.setNumber4_2(Integer.parseInt(number4_2Input.getText().toString()));
        dbPhase4.setNote2(note4_2Input.getText().toString());
