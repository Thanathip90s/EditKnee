...
public class Phase2_4 extends UsageBaseActivity2 {
    ...
    private EditText note2_4Input, editNum;
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn_nextPhase2:
                ...
                if (counter >= 0 && counter <= intEdt - 1 && note2_4Input.getText().toString().equals("")) {
                    Toast.makeText(this, "กรุณากรอกสาเหตุคะ", Toast.LENGTH_SHORT).show();
                } else if (counter >= 0 && counter <= intEdt - 1 && note2_4Input != null) {
                    saveDbPhase2();
                } else {
                    saveDbPhase2();
                }
