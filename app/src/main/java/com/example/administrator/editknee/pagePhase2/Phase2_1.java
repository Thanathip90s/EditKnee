...
public class Phase2_1 extends UsageBaseActivity2 {
    ...
    private EditText note2_1Input,editNum;
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn_nextPhase2:
                ...
                if (counter >= 0 && counter <= intEdt-1 && note2_1Input.getText().toString().equals("")) {
                    Toast.makeText(this, "กรุณากรอกสาเหตุคะ", Toast.LENGTH_SHORT).show();
                } else if (counter >= 0 && counter <= intEdt-1 && note2_1Input != null) {
                    saveDbPhase2();
                } else {
                    saveDbPhase2();
                }
